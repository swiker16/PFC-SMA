...
<body class="body">
    ...
    <a href="form_añadir_pelicula.php?id=' . $bar['bar_id'] . '" class="btn btn-primary btn-sm mt-3">Añadir nueva película</a>
        ...
        <tbody>
            <?php
                foreach ($resultados as $pelicula) {
                    ...
                    echo '<td><img src="data:image/jpeg;base64,' . base64_encode($pelicula['imagen']) . '" class="img-thumbnail" style="max-width: 100px;" alt="Película"></td>';
